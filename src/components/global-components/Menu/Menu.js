        ...
        <>
            <nav className="grid-menu-principal">
                    ...
                    <div className="contenedor-menu-boton">
                        {
                            ancho <= 800 ? (
                                <>
                                    <img
                                        src={publicUrl + "assets/img/icons/menu.svg "}
                                        alt="logo"
                ...
                <div className="grid-menu-buscador">
                    <div className="formulario-buscar">
                        ...
                        >
                            {formBusqueda ? (
                                <Link to="/busqueda">
                                    <img src={publicUrl + "assets/img/icons/search.svg "} alt="logo" />
                                </Link>
                            ) : (
                                <img src={publicUrl + "assets/img/icons/search.svg "}  alt="logo" />
                            )
                ...
                >
                    ...
                    // onMouseEnter={estadoEncimaCategoria}
                    >
                        <img src={publicUrl + "assets/img/icons/menu.svg "} alt="logo" />
                        ...
                        exiteUsuario ? (
                            usuario.Rol == "administrador" ? (
                                <Link to="/administrador/reportes" className="icono-perfiles">
                                    <img src={publicUrl + "assets/img/icons/user.svg "} alt="logo" />
                                </Link>
                            ) : (
                            ...
                            <Link to="/registrar" className="icono-perfiles">
                                <img src={publicUrl + "assets/img/icons/login.svg "} alt="logo" />
                            </Link>
                        )
                    }
                    <Link to="/checkout">
                        <img src={publicUrl + "assets/img/icons/cart.svg "} alt="logo" />
                        <span>
                        ...
                        >
                            ...
                            {dataCategoria.map((categoria) => (
                                <p
                                    ...
                                    onClick={() => setBotonCategoria(!botonSubcategoria)}
                                    style={
